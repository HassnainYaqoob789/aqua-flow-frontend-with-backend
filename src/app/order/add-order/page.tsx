...
export default function AddOrder() {
  ...
  const showDeposit = formData.withBottles && totalDeposit > 0;
  ...
  useEffect(() => {
    ...
    const depositTaking = showDeposit ? (parseFloat(formData.depositAmountTaking) || 0) : 0;
    const total = (productTotal + depositTaking).toFixed(2);

    setFormData((prev) => ({ ...prev, amount: total }));
  }, [formData.items, formData.depositAmountTaking, showDeposit]);
  ...
  const handleWithBottlesChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      withBottles: isChecked,
      ...(!isChecked && { depositAmountTaking: "0" })
    }));
  };
  ...
  const validateForm = (): boolean => {
    ...
    if (showDeposit) {
      ...
      if (isNaN(depositTaking) || depositTaking < 0) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload: CreateOrderPayload = {
        ...
        ...(formData.withBottles && depositTaking > 0 && {
          acceptableDepositAmount: depositTaking,
        }),
  ...
  const handleCustomerSelect = (customerId: string) => {
    ...
    handleCustomerChange(syntheticEvent);
  };
  ...
  // Filter products based on recurring order setting
  const filteredProducts = formData.isRecurring ? products.filter((p) => p.isReusable) : products;
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-5 dark:border-gray-700 dark:bg-gray-900">
                ...
                <div className="space-y-4">
                  ...
                  {formData.isRecurring && !formData.selectedReusableProduct && (
                    <p className="pl-7 text-sm text-red-500">
                      Please select a reusable product before enabling recurring orders.
                    </p>
                  )}

                  {/* WITH BOTTLES CHECKBOX — moved here */}
                  {/* {formData.isRecurring && (
                    ...
                    {filteredProducts.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative flex flex-col items-center rounded-lg border p-3 transition-all hover:shadow-lg hover:scale-105 ${qty > 0
                        ...
                        >
                          ...
                          <div className="text-center">
                            ...
                            {(p.depositAmount ?? 0) > 0 && formData.withBottles && (
                              <p className="mt-1 text-xs text-orange-600 dark:text-orange-400 font-medium">
                                +PKR {p.depositAmount ?? 0} deposit
                              </p>
                            )}

                            {/* ♻️ Reusable Icon */}
                            {p.isReusable && (
                              <div className="mt-2 flex items-center justify-center gap-1 text-xs font-medium text-green-600 dark:text-green-400">
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-100 dark:bg-gray-800">
                        <tr>
                          ...
                          {showDeposit && <th className="py-3 px-4 text-center text-sm font-medium">Deposit</th>}
              ...
              {/* Total Deposit Amount (only if withBottles and totalDeposit > 0) */}
              {showDeposit && (
                <div className="mt-6">
                  <label className="mb-2 flex items-center gap-2 text-sm font-medium">
              ...
              {/* Deposit Taking Amount (only if withBottles and totalDeposit > 0) */}
              {showDeposit && (
                <div className="mt-6">
                  <label className="mb-2 flex items-center gap-2 text-sm font-medium">
              ...
              <div className="mt-6">
                ...
                <FieldHelper
                  text={
                    depositTaking > 0
                      ? `Product Total + Deposit Taking = PKR ${productTotal.toFixed(2)} + PKR ${depositTaking.toFixed(2)}`
                      : `Product Total = PKR ${productTotal.toFixed(2)}`
                  }
                />
              </div>
